...
export const updateWorkflow = (workflow_id: string, req: UpdateWorkflowRequest) => {
  return request.post<BaseResponse<any>>(`/workflows/${workflow_id}`, req)
}
...
export const deleteWorkflow = (workflow_id: string) => {
  return request.post<BaseResponse<any>>(`/workflows/${workflow_id}/delete`)
}
...
export const updateDraftGraph = (workflow_id: string, req: UpdateDraftGraphRequest) => {
  return request.post<BaseResponse<any>>(`/workflows/${workflow_id}/draft-graph`, req)
}

// 发布指定的工作流
export const publishWorkflow = (workflow_id: string) => {
  return request.post<BaseResponse<any>>(`/workflows/${workflow_id}/publish`)
}

// 取消发布指定的工作流
export const cancelPublishWorkflow = (workflow_id: string) => {
  return request.post<BaseResponse<any>>(`/workflows/${workflow_id}/cancel-publish`)
}
...
export const debugWorkflow = (
  ...
  return ssePost(`/workflows/${workflow_id}/debug`, inputs, onData)
}
